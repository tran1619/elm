module RippleCarryAdderTests exposing (andGateTests, fullAdderTests, halfAdderTests, inverterTests, orGateTests, rippleCarryAdderTests)
...
halfAdderTests =
    describe "Half Adder"
        ...
        , test "sum is 1 and carry-out is 0 when first input is 0, second input is 1" <|
            \_ ->
                halfAdder 0 1
                    |> Expect.equal { carry = 0, sum = 1}
        , test "sum is 1 and carry-out is 0 when first input is 1, second input is 0" <|
            \_ ->
                halfAdder 1 0
                    |> Expect.equal { carry = 0, sum = 1}
...
rippleCarryAdderTests =
    describe "4-bit ripple carry adder"
        ...
        , describe "when the ist input is 1111, and the 2nd input is 1111"
        ...
        , describe "when the first input is 0000, and the 2nd input is 0000"
