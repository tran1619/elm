module RippleCarryAdder exposing ( andGate, Binary, digits, extractDigits, fullAdder, halfAdder, inverter, orGate, rippleCarryAdder )

import Array
import Bitwise


andGate a b = Bitwise.and a b

orGate a b = Bitwise.or a b
